<!-- Footer -->
<footer class="page-footer bg-accent pb-5">
    <div class="container text-center ">
        <div class="text-center">
            <h5 class="mb-3 mt-sm-3 mt-lg-0">
            Marca inregistrata <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-emoji-smile-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
